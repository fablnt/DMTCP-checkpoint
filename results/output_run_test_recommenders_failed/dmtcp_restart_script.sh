#!/bin/bash
export DMTCP_COORD_HOST=lrdn3301.leonardo.local
...
given_ckpt_files=" ./output_run_test_recommenders_prova4/ckpt_python3.8_636e35743c6ca21c-40000-6d0f36fbdac36.dmtcp"
