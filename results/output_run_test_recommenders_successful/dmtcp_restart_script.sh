#!/bin/bash
export DMTCP_COORD_HOST=login02.leonardo.local
...
ckpt_timestamp="Tue Jul  8 16:41:04 2025"
...
given_ckpt_files=" ./output_run_test_recommenders_test6/ckpt_python3.8_29d376abdcc7b210-40000-3fecc5bf4693b.dmtcp"
